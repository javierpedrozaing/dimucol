...
class ContratosControllerTest < ActionController::TestCase
  ...
  test "should create contrato" do
    assert_difference('Contrato.count') do
      post :create, contrato: { descuento: @contrato.descuento, estado: @contrato.estado, fechaFinal: @contrato.fechaFinal, fechaInicial_datetime: @contrato.fechaInicial_datetime, valorTotal: @contrato.valorTotal }
    end
  ...
  test "should update contrato" do
    patch :update, id: @contrato, contrato: { descuento: @contrato.descuento, estado: @contrato.estado, fechaFinal: @contrato.fechaFinal, fechaInicial_datetime: @contrato.fechaInicial_datetime, valorTotal: @contrato.valorTotal }
    assert_redirected_to contrato_path(assigns(:contrato))
  end
